...
Map<String, dynamic> bookingJson({
  ...
  String? pickupLocationNameTh,
  String pickupLocationAddress = '999 Nong Prue, Bang Phli',
  String destinationLocationName = 'Test Hotel',
  String? destinationLocationNameTh,
  String destinationLocationAddress = 'Bangkok',
  ...
  final json = <String, dynamic>{
    ...
    'destinationLocation': {
      ...
      'nameTh': ?destinationLocationNameTh,
...
BookingSummary bookingSummary({
  ...
  bookingJson(
    ...
    pickupLocationNameTh: pickupLocationNameTh,
    pickupLocationAddress: pickupLocationAddress,
    destinationLocationName: destinationLocationName,
    destinationLocationNameTh: destinationLocationNameTh,
...
Map<String, dynamic> settlementJson({
  ...
  num? companyCommissionAmount = 300,
  num? driverExpectedIncomeAmount = 900,
  num? nameSignAmount,
}) => {
  'bookingNumber': bookingNumber,
  'status': status,
