...
typedef DriverCallSocketEventHandler =
    void Function(String event, Map<String, dynamic> payload);
...
class DriverCallSocketBridge {
  ...
  DriverCallSocketEventHandler? onCallEvent;
  ...
  void dispatchCall(String event, Map<String, dynamic> payload) {
    onCallEvent?.call(event, payload);
  }
}
