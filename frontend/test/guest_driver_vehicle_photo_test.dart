...
void main() {
  testWidgets('assigned driver card is hidden before driver assignment', (
    tester,
  ) async {
  ...
  testWidgets('assigned driver card shows vehicle photo after assignment', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: AssignedDriverStatusCard(
            result: GuestBookingLookupResult.fromJson(
              _lookupJson(
                assignedDriver: {
                  'name': 'Driver A',
  ...
  testWidgets('vehicle photo widget shows load failure message', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('vehicle photo widget renders fetched image bytes', (
    tester,
  ) async {
  ...
  testWidgets(
    'lookup page has no horizontal overflow at 360px with driver photo card',
    (tester) async {
