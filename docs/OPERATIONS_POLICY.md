...
## 예약 취소/환불 정책 (2026-08-20 제정)
- 예약 확정 후 24시간 이내 무료 취소 (위약금 없음)
- 동일 조건 더 저렴한 확정 견적 발견 시, 예약 후 48시간 이내 문의하면 차액 환불
- 웹 노출: 랜딩페이지 신뢰요소 섹션 카드 4 (5개 언어 지원)

## 기사 신고 대응 정책 (2026-08-20 제정)
- 신고 채널: 예약 상세 화면 내 신고 기능 또는 카카오톡/전화
- 접수 후 24시간 이내 확인 연락
- 반복 신고 확인 기사: 배차 제한
- 중대 사안(안전위협/폭언 등): 즉시 배차 정지
- 웹 노출: 랜딩페이지 신뢰요소 섹션 카드 5 (5개 언어 지원)
