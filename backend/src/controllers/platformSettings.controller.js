...
const getPublic = asyncHandler(async (_req, res) => success(res, await service().get()));
const getAdmin = asyncHandler(async (_req, res) => success(res, await service().get()));
...
const getAsset = asyncHandler(async (req, res) => res.sendFile(await service().getImage(req.params.kind)));
