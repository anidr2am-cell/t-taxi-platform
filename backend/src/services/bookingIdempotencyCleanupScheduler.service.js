...
class BookingIdempotencyCleanupSchedulerService {
  ...
  start() {
    ...
    this.started = true;
    logger.info('Booking idempotency cleanup worker startup', {
  ...
  stop() {
    ...
    this.started = false;
    this.nextExpectedRunAt = null;
    logger.info('Booking idempotency cleanup worker stopped');
  }
...
module.exports = BookingIdempotencyCleanupSchedulerService;
