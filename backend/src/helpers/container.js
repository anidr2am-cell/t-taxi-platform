...
const HomeBannerRepository = require("../repositories/homeBanner.repository");
const HomeBannerService = require("../services/homeBanner.service");
...
container.register(
  "tokenService",
  (c) => new TokenService(c.get("revokedRefreshTokenStore")),
);
container.register(
  "authService",
  (c) => new AuthService(
...
container.register("homeBannerRepository", () => new HomeBannerRepository());
container.register(
  "homeBannerService",
  (c) => new HomeBannerService(c.get("homeBannerRepository")),
);
container.register(
  "socialAuthService",
...
container.register(
  "vehicleService",
  (c) => new VehicleService(c.get("vehicleRepository")),
);
container.register(
  "vehicleRecommendationService",
  (c) => new VehicleRecommendationService(c.get("vehicleRepository")),
);
...
container.register(
  "vehiclePriceAdminService",
  (c) =>
    new VehiclePriceAdminService(
      c.get("vehiclePriceRepository"),
      c.get("routeRepository"),
      c.get("vehicleRepository"),
    ),
...
container.register(
  ...
  (c) => new AdminDashboardService(c.get("adminDashboardRepository")),
);
container.register(
  "flightService",
  () =>
...
container.register(
  ...
  (c) =>
    new CommissionSettlementService(
      database.pool,
      c.get("bookingRepository"),
      c.get("driverRepository"),
      c.get("fileRepository"),
...
container.register(
  "adminQrReissueService",
  (c) => new AdminQrReissueService(database.pool, c.get("bookingRepository")),
);
container.register(
  "adminDispatchService",
  (c) =>
    new AdminDispatchService(
      database.pool,
      c.get("bookingRepository"),
      c.get("driverRepository"),
      c.get("bookingStatusService"),
...
container.register(
  "outboxRepository",
  () => new OutboxRepository(database.pool),
);
container.register(
  "outboxProcessor",
  (c) =>
...
container.register(
  ...
  () => new FlightMonitorRepository(),
);
container.register(
  "driverApplicationRepository",
  () => new DriverApplicationRepository(),
);
container.register(
  "supportInquiryRepository",
  () => new SupportInquiryRepository(),
);
container.register(
  "adminFlightMonitorService",
  (c) =>
    new AdminFlightMonitorService(
      database.pool,
      ...
      c.get("outboxProcessor"),
      {
        ...
        delayNotificationDeltaMinutes:
          config.external.flightDelayNotificationDeltaMinutes,
      },
    ),
);
container.register(
...
container.register(
  "flightSyncSchedulerService",
  (c) =>
    new FlightSyncSchedulerService(
...
container.register(
  ...
  (c) =>
    new SupportInquiryService(database.pool, c.get("supportInquiryRepository")),
);
